...
{
public:
  CollisionChecker(nav2_costmap_2d::Costmap2DROS* costmap_ros, double obstacle_factor = 1.0)
   ...
   */
  nav2_costmap_2d::Costmap2DROS* getCostmapROS() const;
...
private:
  nav2_costmap_2d::Costmap2DROS* costmap_ros_;  // costmap ROS wrapper
