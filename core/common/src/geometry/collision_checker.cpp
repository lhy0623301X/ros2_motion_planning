 ...
 */
nav2_costmap_2d::Costmap2DROS* CollisionChecker::getCostmapROS() const
{
  return costmap_ros_;
}
...
bool CollisionChecker::inCollision(const unsigned int& i, const bool& traverse_unknown)
{
  ...
  if (center_cost == nav2_costmap_2d::NO_INFORMATION && traverse_unknown)
  {
    return false;
  }
  // if occupied or unknown and not to traverse unknown space
  return center_cost >= nav2_costmap_2d::INSCRIBED_INFLATED_OBSTACLE * obstacle_factor_;
}
