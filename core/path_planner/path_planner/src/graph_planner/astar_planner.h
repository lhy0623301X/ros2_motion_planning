 ...
 */
#ifndef RMP_PATH_PLANNER_GRAPH_PLANNER_ASTAR_PLANNER_H_
#define RMP_PATH_PLANNER_GRAPH_PLANNER_ASTAR_PLANNER_H_
...
{
public:
  explicit AStarPathPlanner(std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros);
...
#endif  // RMP_PATH_PLANNER_GRAPH_PLANNER_ASTAR_PLANNER_H_
