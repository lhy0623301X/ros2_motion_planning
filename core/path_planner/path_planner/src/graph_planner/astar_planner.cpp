 ...
 */
AStarPathPlanner::AStarPathPlanner(costmap_2d::Costmap2DROS* costmap_ros, bool dijkstra,
                                   bool gbfs)
 ...
 */
bool AStarPathPlanner::plan(const Point3d& start, const Point3d& goal, Points3d* path,
                            Points3d* expand) {
